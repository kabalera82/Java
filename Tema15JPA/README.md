...
Acceso a bases de datos relacionales con JDBC (Java Database Connectivity). Patron DAO para separar la logica de acceso a datos de la logica de negocio.
...
>
> ⚠️ **SEGURIDAD:** hay una password de base de datos hardcodeada en `Conexion.java`. Ver [README raiz](../README.md#bugs-y-errores-pendientes).
>
...
// 5. Cerrar recursos (try-with-resources lo hace automaticamente)
```
...
// Implementacion — contiene el JDBC
...
# La BD 'tutorial' se crea automaticamente (createDatabaseIfNotExist=true)
...
> **Nota:** antes de ejecutar, cambia el valor de `PASSWORD` en `Conexion.java` por el de tu instalacion MySQL, o mejor, exteriorizalo a una variable de entorno.
